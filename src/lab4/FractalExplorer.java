...
public class FractalExplorer
{
    ...
    public void createAndShowGUI()
    {
        ...
        JFrame myframe = new JFrame("Фрактальный отображатель");
        ...
        JButton resetButton = new JButton("Сбрось меня");

        /** Instance of the ResetHandler on the reset button. */
        ResetHandler handler = new ResetHandler();
        resetButton.addActionListener(handler);

        /** кнопка крепится к верху тк так удобнее */
        myframe.add(resetButton, BorderLayout.NORTH);
